...
async def scrape_cashfree():
    result = {
        "competitor_name": "Cashfree",
    ...
    async with async_playwright() as p:
        ...
        try:
            await page.goto("https://cashfree.com", wait_until='networkidle')
        ...
        try:
            await page.goto("https://cashfree.com/pricing", wait_until='networkidle')
            await asyncio.sleep(random.uniform(1.5, 3.5))
        ...
        try:
            await page.goto("https://cashfree.com/features", wait_until='networkidle')
            await asyncio.sleep(random.uniform(1.5, 3.5))
        ...
        try:
            await page.goto("https://cashfree.com/blog", wait_until='networkidle')
            await asyncio.sleep(random.uniform(1.5, 3.5))
        ...
        try:
            await page.goto("https://cashfree.com/reviews", wait_until='networkidle')
            await asyncio.sleep(random.uniform(1.5, 3.5))
        ...
        try:
            await page.goto("https://cashfree.com/careers", wait_until='networkidle')
            await asyncio.sleep(random.uniform(1.5, 3.5))
        ...
        await page.screenshot(path="cashfree_screenshot.png")

        with open("data/raw/cashfree_raw.json", "w") as f:
            json.dump(result, f, indent=4)

        await browser.close()

asyncio.run(scrape_cashfree())