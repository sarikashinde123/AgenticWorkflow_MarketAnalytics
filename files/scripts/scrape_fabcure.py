...
async def Fabcure_scrape():
    async with async_playwright() as p:
        browser = await p.chromium.launch()
        page = await browser.new_page()
        try:
            await page.goto('https://fabcure.in', wait_until='networkidle')
            ...
            await page.screenshot(path='Fabcure_screenshot.png')
        ...
        data = {
            "competitor_name": "Fabcure",
            "website": "https://fabcure.in",
        ...
        with open('data/raw/Fabcure_raw.json', 'w') as f:
            json.dump(data, f)
        await browser.close()

asyncio.run(Fabcure_scrape())